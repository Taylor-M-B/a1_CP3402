CREATE TABLE IF NOT EXISTS `#__a1s_details` (
...
INSERT INTO `#__a1s_details` (`name`) VALUES
('Nina'),
('Astrid'),
('Elmar');
...
ALTER TABLE `#__a1s_details` ADD COLUMN  `published` tinyint(1) NOT NULL DEFAULT 0 AFTER `alias`;

ALTER TABLE `#__a1s_details` ADD COLUMN  `publish_up` datetime AFTER `alias`;

ALTER TABLE `#__a1s_details` ADD COLUMN  `publish_down` datetime AFTER `alias`;

ALTER TABLE `#__a1s_details` ADD KEY `idx_state` (`published`);

ALTER TABLE `#__a1s_details` ADD COLUMN  `language` char(7) NOT NULL DEFAULT '*' AFTER `alias`;

ALTER TABLE `#__a1s_details` ADD KEY `idx_language` (`language`);

ALTER TABLE `#__a1s_details` ADD COLUMN  `ordering` int(11) NOT NULL DEFAULT 0 AFTER `alias`;
