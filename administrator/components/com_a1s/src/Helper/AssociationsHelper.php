...
use Joomla\Component\A1s\Site\Helper\AssociationHelper;
...
class AssociationsHelper extends AssociationExtensionHelper
{
	 ...
	 * @since   1.0.0
	 */
	protected $itemTypes = ['a1', 'category'];
	...
	public function getItem($typeName, $id)
	{
		...
		{
			case 'a1':
				$table = Table::getInstance('A1Table',
					'Joomla\\Component\\A1s\\Administrator\\Table\\');
				break;
