...
(function () {
  ...
  /**
    ...
    * View element calls jSelectA1 when a a1 is clicked
    * jSelectA1 creates the link tag, sends it to the editor,
    * and closes the select frame.
    */

  window.jSelectA1 = function (id, title, catid, object, link, lang) {
    var hreflang = '';

    if (!Joomla.getOptions('xtd-a1s')) {
      // Something went wrong
      window.parent.Joomla.Modal.getCurrent().close();
      return false;
    }

    var _Joomla$getOptions = Joomla.getOptions('xtd-a1s'),
